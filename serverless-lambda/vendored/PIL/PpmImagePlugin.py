...
def _save(im, fp, filename):
    if im.mode == "1":
        ...
        raise IOError(f"cannot write mode {im.mode} as PPM")
    fp.write(head + ("\n%d %d\n" % im.size).encode('ascii'))
    if head == b"P5" and rawmode == "I;16B":
        fp.write(b"65535\n")
    elif head == b"P5" and rawmode == "I;32B":
        fp.write(b"2147483648\n")
    elif head == b"P5" and rawmode == "L" or head != b"P5" and head == b"P6":
        fp.write(b"255\n")
